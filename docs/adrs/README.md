...
| [Pi-backed Assistant runtime and Codex credential boundary](2026-07-19-pi-backed-assistant-runtime.md) | Proposed | Run Pi behind service-owned model/auth capabilities, keep Codex credentials machine-local, and give the bundled Assistant only brokered read-only workspace tools. |
